...
namespace AddressParserLib1
{
    ...
    ///     </para>
    /// </summary>
    public class AddressParser1 : AdressParserAbstract
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressParser1"/> class.
        /// </summary>
        public AddressParser1()
        {
        ...
        /// The default parser.
        /// </value>
        public static AddressParser1 Default { get; } = new AddressParser1();
        ...
        public override AddressParseResult ParseAddress(string input, Regex pattern, bool normalize)
        {
            ...
            if (!match.Success)
            {
                //211 TOWNE CENTER CIR, SANFORD, FL 32771.0 
                return null;
            }
